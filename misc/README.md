...
| `rtkbtusb-1.19.14-src.zip`         | Plain (non-DKMS) `rtk_btusb` source — `make` builds against `/lib/modules/$(uname -r)/build`. |
...
# WiFi:
dpkg-deb -x rtl8852bu-dkms_1.19.14_arm64.deb x && cd x/usr/src/rtl8852bu-1.19.14
